...
const useStudy = (slug: string) => {
  ...
  return {
    ...
    optimization_goal: studyQuery.data?.optimization_goal ?? '',
    destination_type: studyQuery.data?.destination_type ?? '',
    page_id: studyQuery.data?.page_id ?? '',
    instagram_id: studyQuery.data?.instagram_id ?? '',
    min_budget: studyQuery.data?.min_budget ?? '',
    opt_window: studyQuery.data?.opt_window ?? '',
    ad_account: studyQuery.data?.ad_account ?? '',
