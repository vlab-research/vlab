...
// Rather than nesting, you could build up a "row"
// or object with more and more information
// and then you can always "groupby" later
// this level just adds the "form"
// id
...
// This level would add the "flow" id
function _combineSplits(split) {
  // Combines forms that are the same form
  // thus preventing repeating without leaving
