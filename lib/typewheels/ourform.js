...
async function getForm(pageid, shortcode, event) {
  if (!pageid || !shortcode || !event) {
    throw new TypeError(`Trying to get a form without a pageid or shortcode or event! ${pageid}, ${shortcode}, ${event}`)
  }
