...
describe('getState', () => {
  ...
  it('Responds when it gets external events that fulfill timeout conditions', () => {
    const wait = {
      operator: 'or',
      conditions:
    ...
    // value should be...?
    const externalEvent = { synthetic: true,
                            type: 'external',
  ...
  it('Responds when it gets multiple events that fulfill all conditions', () => {
    ...
    const externalEventA = { synthetic: true,
                            event: { type: 'moviehouse:startVideo', id: '809243}' }}

    // value should be...?
    const externalEventB = { synthetic: true,
                            type: 'external',
                            event: { type: 'timeout', value: 2843098034 }}
