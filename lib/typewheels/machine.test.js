...
const { echo, tyEcho, statementEcho, repeatEcho, delivery, read, qr, text, sticker, multipleChoice, referral, USER_ID, reaction, syntheticBail, syntheticPR } = require('./events.test')
...
describe('getState', () => {
  ...
  it('It ignores a good platform response', () => {
  ...
  it('It gets into a blocked state when given a bad platform response', () => {
  ...
  it('It gets out of a blocked state if an echo follows a bad platform response', () => {
  ...
  it('It gets out of a blocked state if a user responds', () => {
