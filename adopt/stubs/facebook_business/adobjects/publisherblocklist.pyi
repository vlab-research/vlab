...
class PublisherBlockList(AbstractCrudObject):
    ...
    def create_append_publisher_url(self, fields: Incomplete | None = None, params: Incomplete | None = None, batch: Incomplete | None = None, success: Incomplete | None = None, failure: Incomplete | None = None, pending: bool = False): ...
